...
If the analysis is extensive, deliver the highest-priority threats first (those that are both high-impact and inadequately mitigated). Note remaining sections available on request.
