...
**Hard constraints:**
- Maximum 10 findings per run. Prioritize inconsistencies over style preferences.
- Write findings incrementally. Do not accumulate a single large response.

**If output would exceed comfortable length:**
Stop. Deliver what you have. State which review dimensions remain and offer to continue.
